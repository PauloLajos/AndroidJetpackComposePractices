...
@Composable
fun HomeScreen(
    navigateToTaskItemEntry: () -> Unit,
    navigateToTaskItemUpdate: (Long) -> Unit,
    ...
    Scaffold(
        ...
        floatingActionButton = {
            FloatingActionButton(
                onClick = navigateToTaskItemEntry,
        ...
        HomeBody(
            taskItemList = homeUiState.taskList,
            onItemClick = navigateToTaskItemUpdate,
            modifier = modifier
...
private fun HomeBody(
    taskItemList: List<TaskItem>, onItemClick: (Long) -> Unit, modifier: Modifier = Modifier
) {
    Column(
...
private fun TaskList(
    taskItemList: List<TaskItem>, onItemClick: (TaskItem) -> Unit, modifier: Modifier = Modifier
) {
    LazyColumn(modifier = modifier) {
        items(items = taskItemList, key = { it.id }) { item ->
            ShowTaskItem(item = item,
                modifier = Modifier
...
private fun ShowTaskItem(
    item: TaskItem, modifier: Modifier = Modifier
) {
    Card(
